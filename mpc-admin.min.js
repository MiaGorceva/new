 ...
 ( function( $ ) {
	...
	$.widget( 'wp.wpColorPicker', $.wp.wpColorPicker, {
		_create: function() {
			...
			// set inputWrapper for toggling close/open
			...
			el.iris( {
				...
				palettes: [ '#ffffff', '#f3f3f3', '#888888', '#555555', '#333333', '#75CDDE', '#F29760', '#88D482', '#DF5461', '#B39A68' ],
	...
	$.widget( 'a8c.iris', $.a8c.iris, {
		_create: function() {
			...
			if( this.element.is( 'input' ) && ( this.element.is( '.mpc-color-picker' ) || this.element.parents( '.mpc-color-picker' ).length != 0 ) ) {
			...
			if ( typeof this.options.alpha !== 'undefined' && this.options.alpha ) {
				...
				if( self._color._alpha < 1 ) {
					self.element.addClass( 'mpc-color-rgba' );
				} else {
					self.element.removeClass( 'mpc-color-rgba' );
				}
		...
		_change: function() {
			...
			if ( this.options.alpha ) {
				...
				// Generate background slider alpha, only for CSS3 old browser duck!! :)
...
;(function (factory) {
	...
	$.fn.MPCdatetimepicker = function (opt, opt2) {
		var result = this,
			KEY0 = 48,
			KEY9 = 57,
			_KEY0 = 96,
	...
	$.fn.MPCdatetimepicker.defaults = default_options;
